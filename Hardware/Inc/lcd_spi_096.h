...
#define 	GPIO_LCD_CS_CLK     			__HAL_RCC_GPIOB_CLK_ENABLE()	// CS引脚IO口时钟

#define  LCD_DC_PIN						GPIO_PIN_6				         // 数据指令选择  引脚				
#define	LCD_DC_PORT						GPIOB									// 数据指令选择  GPIO端口
#define 	GPIO_LCD_DC_CLK     			__HAL_RCC_GPIOB_CLK_ENABLE()	// 数据指令选择  GPIO时钟 	

#define  LCD_Backlight_PIN				GPIO_PIN_7				         // 背光  引脚				
#define	LCD_Backlight_PORT			GPIOB									// 背光 GPIO端口
#define 	GPIO_LCD_Backlight_CLK     __HAL_RCC_GPIOB_CLK_ENABLE()	// 背光 GPIO时钟 	
...
#define 	LCD_Backlight_OFF     HAL_GPIO_WritePin(LCD_Backlight_PORT, LCD_Backlight_PIN, GPIO_PIN_RESET)// 低电平，开启背光
#define 	LCD_Backlight_ON  	HAL_GPIO_WritePin(LCD_Backlight_PORT, LCD_Backlight_PIN, GPIO_PIN_SET)	// 高电平，关闭背光
