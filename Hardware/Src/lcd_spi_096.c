...
// 以下进行一些驱动的默认设置
   ...
   LCD_SetAsciiFont(&CH_Font24);       // 设置默认字体
...
*
*	入口https://shop252966792.taobao.com参数:	direction - 要显示的方向
*
*	函数功能:	设置要显示的方向
*
...
*					3. 可设置对应的背景色，例如使用 LCD_SetBackColor(0x000000) 设置为黑色的背景色
*					4. 使用示例 LCD_DisplayString( 10, 10, "极客KE") ，在起始坐标为(10,10)的地方显示字符串"极客KE"
*
*****************************************************************************************************************************************/
...
/******************************************************************************************************************************************
*	函 数 名:	LCD_DisplayChinese https://shop252966792.taobao.com
*
*	入口参数:	x - 起始水平坐标
*					y - 起始垂直坐标
*					pText - 中文字符
...
*					2.	可设置要显示的颜色，例如使用 LCD_SetColor(0xff0000FF) 设置为蓝色
*					3. 可设置对应的背景色，例如使用 LCD_SetBackColor(0xff000000) 设置为黑色的背景色
*					4. 使用示例 LCD_DisplayChinese( 10, 10, "极客科技STM32") ，在坐标(10,10)显示字符串"极客科技STM32"
*
**********************************************************************************************************************************极客ke*******/
